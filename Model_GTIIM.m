%  程序名称: GTIIMmodel（灰色投射四面体综合关联模型）
%  程序功能: 分析两组序列间的关联程度
%  数据输入：各数组序列
%  结果输出：1.GTIIM关联度 2.序关系矩阵 3.聚类图谱
clc,clear all;
format short g;
fprintf(2,'灰色投射四面体综合关联模型GTIIMmodel：\n')


%% %%%%%%%%%%%%%%%%%%%%%%%% 将.xls数据文件添加到路径 %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% mkdir('/Users/anyimeng/科研/MATLABCode/MATLAB_GTIIM/Table') ;  
% addpath('/Users/anyimeng/科研/MATLABCode/MATLAB_GTIIM/Table') ; 
% savepath /Users/anyimeng/科研/MATLABCode/MATLAB_GTIIM/Table/pathdef.m ;
